...
- **Generative AI:** any AI system that creates new content (i.e. text, music, images, code, etc.) by learning from patterns in data (cross-cuts multiple subfields)
	...
	- *LLMs* (specific application of generative AI)**→ text generation, *GANs* → image, video generation, *Diffusion models* → image, video generation
- **Discriminative AI:** learning the boundaries that separate different classes or categories in the training data
	- Just try to classify (not generate)
